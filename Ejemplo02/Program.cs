...
new TransactionOptions { IsolationLevel = IsolationLevel.Serializable }))
    {
        ...
        {
            // Obtener el salo de la cuenta de origen
                ...
                || originAccountBalance.Balance < quantityToTransfer)
            {
                Console.WriteLine($"Transacción Fallida: " +
                    $"El saldo es menor que el dinero necesario " +
            ...
            Console.WriteLine($"Retiro de la cuenta 1 con éxito");

            // Realizar la operación de depósito
            using (var dbContext2 = new Bank2Context())
            {
                // Depositar el dinero a la cuenta de destino
                ...
                Console.WriteLine($"Depósito en la cuenta 2 con éxito");
            }

            // Confirmar la transacción
            scope.Complete();
            Console.WriteLine("Trasancción confirmada...");
        }
    }
}
catch (Exception ex)
